    ...
    <form onSubmit={handleSubmit} className="mb-6">
      ...
      <div className="flex gap-2 mb-3">
        <input
          ...
          className="flex-1 px-4 py-3 rounded-xl border-2 border-[#136b13] focus:from-[#00BF00] focus:outline-none text-gray-800 placeholder-gray-400 transition-all duration-300 shadow-sm focus:shadow-md"
        />
        <button
          type="submit"
        ...
        <div className="flex gap-2">
          {priorities.map(p => (
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-xs font-semibold transition-all duration-300 transform hover:scale-110 ${priority === p.id
